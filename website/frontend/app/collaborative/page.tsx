...
export default function CollaborativeFilteringPage() {
  ...
  // We've removed the advanced mode states as they're no longer needed

  // We've removed the handleGetRecommendations function as it's no longer needed
  ...
  // We've removed the toggleAdvancedMode function as it's no longer needed
        ...
        <div className="w-full mx-auto">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8 shadow-xl">
            <p className="text-gray-300 mb-6">
              Collaborative filtering is a recommendation technique that makes predictions about a user's interests by collecting preferences from many users. Unlike content-based filtering (which uses book attributes) or popularity-based recommendations (which uses overall popularity), collaborative filtering leverages the wisdom of the crowd to find patterns in user behavior.
            </p>

            <h3 className="text-xl font-medium mb-4 text-white">Key Components</h3>
            
            <div className="mb-6">
              <h4 className="text-lg font-medium mb-2 text-blue-300">1. Data Filtering and Matrix Creation</h4>
              <div className="pl-4 border-l-2 border-gray-700 mb-4">
                <p className="font-medium text-gray-200 mb-1">Qualified User/Item Selection:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300 ml-2 mb-3">
                  <li>Filters users with ≥200 ratings and books with ≥50 ratings to ensure data reliability.</li>
                  <li>Reduces computational complexity and improves recommendation quality.</li>
                </ul>
                
                <p className="font-medium text-gray-200 mb-1">Matrix Construction:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300 ml-2">
                  <li>Item-User Matrix: Books as rows, users as columns, filled with ratings.</li>
                  <li>User-Item Matrix: Transpose of the item-user matrix for user-based analysis.</li>
                </ul>
              </div>
            </div>
            
            <div className="mb-6">
              <h4 className="text-lg font-medium mb-2 text-blue-300">2. Similarity Computation</h4>
              <div className="pl-4 border-l-2 border-gray-700">
                <p className="font-medium text-gray-200 mb-1">Cosine Similarity:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300 ml-2 mb-3">
                  <li>Measures the cosine of the angle between rating vectors.</li>
                  <li>Formula: Similarity = (A·B)/(||A||×||B||)</li>
                  <li>Values range from 0 (no similarity) to 1 (identical).</li>
                </ul>
                
                <p className="font-medium text-gray-200 mb-1">Normalization:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-300 ml-2">
                  <li>Adjusts for user rating biases by subtracting mean ratings.</li>
                </ul>
              </div>
            </div>
            
            <h3 className="text-xl font-medium mb-4 text-white">Recommendation Approaches</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div className="flex flex-col p-4 bg-gray-800 rounded-lg">
                <IconUserCircle className="h-10 w-10 text-blue-400 mb-3" />
                <h4 className="text-lg font-medium mb-2 text-white">User-Based Collaborative Filtering</h4>
                <p className="text-gray-300 mb-2 font-medium">Steps:</p>
                <ol className="list-decimal list-inside space-y-1 text-gray-300 mb-3">
                  <li>Find users with similar rating patterns to the target user.</li>
                  <li>Identify books liked by these users but unrated by the target.</li>
                  <li>Predict ratings using a weighted average of similar users' ratings.</li>
                </ol>
                <p className="text-gray-400 text-sm italic">Example: If User A and B both rate fantasy books highly, recommend B's favorite unread fantasy book to A.</p>
              </div>
              
              <div className="flex flex-col p-4 bg-gray-800 rounded-lg">
                <IconPackage className="h-10 w-10 text-blue-400 mb-3" />
                <h4 className="text-lg font-medium mb-2 text-white">Item-Based Collaborative Filtering</h4>
                <p className="text-gray-300 mb-2 font-medium">Steps:</p>
                <ol className="list-decimal list-inside space-y-1 text-gray-300 mb-3">
                  <li>Identify books similar to those the target user has rated.</li>
                  <li>Predict ratings based on similarity-weighted ratings of these items.</li>
                </ol>
                <p className="text-gray-400 text-sm italic">Example: If a user likes The Lord of the Rings, recommend The Wheel of Time due to overlapping reader ratings.</p>
              </div>
            </div>
            
            <div className="bg-blue-900/30 p-5 rounded-lg border border-blue-800 mb-6">
              <h4 className="text-lg font-medium mb-2 text-blue-300">Hybrid Approach</h4>
              <p className="text-gray-300 mb-1">Combines user-based and item-based recommendations with adjustable weights.</p>
              <p className="text-gray-300">Enhances diversity and balances personalization with item relevance.</p>
            </div>
            
            <h3 className="text-xl font-medium mb-3 text-white">Implementation Challenges</h3>
              ...
              <table className="w-full text-sm text-left text-gray-300">
                ...
                <tbody>
                  <tr className="border-b border-gray-700">
                    <td className="px-4 py-3 font-medium">Data Sparsity</td>
                    <td className="px-4 py-3">Filter inactive users/items</td>
                  </tr>
                  <tr className="border-b border-gray-700">
                    <td className="px-4 py-3 font-medium">Scalability</td>
                    <td className="px-4 py-3">Use sparse matrices for efficiency</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 font-medium">Bias in Ratings</td>
                    <td className="px-4 py-3">Normalize by user mean ratings</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          {/* We've removed the Advanced Mode section */}
        </div>
      </TracingBeam>
    </div>
  );
